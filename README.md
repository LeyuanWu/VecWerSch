...
- 📊 Produces: No direct manuscript figure/table; generates NetCDF input for a downstream scripts
- 📦 Required Inputs: `input/Moon_shape_719.sh` *(SHTOOLS binary — LOLA lunar shape model, truncated at **degree 359**)*
- 🖼️ Generated Outputs:
...
- 📦 Required Inputs:
  - `input/moon_topo_Lshp359_15arcmin.nc` *(NetCDF — lunar topography grid at 15 arc-min resolution, calculated from .sh shape model, truncated at **degree 359**)*
...
- 🖼️ Generated Outputs:
  - `output/Moon_gNED_errors.csv` *(Top-10 largest |Δgz| locations with >1000 km separation; used as fixed evaluation points for downstream comparison across 8 topography resolutions)*
...
- 📦 Required Inputs:
  - `input/moon_topo_Lshp359_15arcmin.nc` *(NetCDF — lunar topography grid at 15 arc-min resolution, calculated from .sh shape model, truncated at **degree 359**)*
  - `output/moon_topo_gravity_Lshp359_nmax7.nc` *(NetCDF — SH gravity components; generated by `ex_Moon_TopoGrav_Comp_SH.py`)*
  - `output/moon_topo_gravity_in15arcmin_out15arcmin.nc` *(NetCDF — PH gravity using 15′ input; generated by `ex_Moon_TopoGrav_Comp_PH.py`)*
  - `output/moon_topo_gravity_in6arcmin_out15arcmin.nc` *(NetCDF — PH gravity using 6′ input; generated by `ex_Moon_TopoGrav_Comp_PH.py`)*
...
- 📦 Required Inputs:
  - `input/Moon_shape_719.sh` *(SHTOOLS binary — LOLA lunar shape model, truncated at **degree 359**)*
  - `output/Moon_gNED_errors.csv` *(Top-10 error locations; generated by `ex_Moon_TopoGrav_PH_vs_SH_1.py`)*
- 🖼️ Generated Outputs:
